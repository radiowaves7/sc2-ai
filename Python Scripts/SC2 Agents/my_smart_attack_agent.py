...
class QLearningTable:
    def __init__(self, actions, learning_rate = 0.01, reward_decay = 0.9, e_greedy = 0.9):
        ...
        self.q_table = pandas.DataFrame(columns = self.actions)
...
#Smart agent
class SmartAttackAgent(base_agent.BaseAgent):
    def __init__(self):
        super(SmartAttackAgent, self).__init__()
    ...
    def step(self, obs):
        super(SmartAttackAgent, self).step(obs)
